...
`;
    ...
    console.log(chalk.green(`${PREFIX.SUCCESS}${CREATE.CREATED_FILE("Src/Utils/" + fileName + ".js")}`));

    addExportToIndex(indexPath, Name, fileName);
    console.log(chalk.green(`${PREFIX.SUCCESS}${CREATE.UPDATED_FILE("Src/Utils/index.js")}`));

    console.log(chalk.bold.green(`\n${CREATE.UTIL_DONE(fileName)}\n`));
}
